                        ...
                        <div class="mx-kanban-card align-self-center">
                            <div class="mx-kanban-card__header d-flex">
                                ...
                                <div class="mx-kanban-card__header-action">
                                    <div class="dropdown ">
                                        <button class="btn t-bg-clear t-text-dark--light-40" type="button"
                                    ...
                                    <li>
                                        <a href="#" class="t-link">
                                            <div class="avatars avatars--circle avatars--sm-plus">
                                                <img src="{{ asset('assets') }}/img/avatar.png" alt="max"
                            ...
                            <ul class="t-list">
                                ...
                                <li class="mb-3">
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div class="messages__msg justify-content-center t-width-max">
                                            <div class="avatars avatars--rounded avatars--sm-plus t-mr-8">
                                                <img src="{{ asset('assets') }}/img/user-1.jpg" alt="max"
                                                    class="img-fulid w-100">
                                            </div>
                                            <div class="messages__content messages__content--unseen">
                                                <div class="messages__title">
                                ...
                                <li class="mb-3">
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div class="messages__msg justify-content-center t-width-max">
                                            <div class="avatars avatars--rounded avatars--sm-plus t-mr-8">
                                                <img src="{{ asset('assets') }}/img/overlay-1.jpg" alt="max"
                                                    class="img-fulid w-100">
                                            </div>
                                            <div class="messages__content messages__content--unseen">
                                                <div class="messages__title">
                                ...
                                <li class="mb-0">
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div class="messages__msg justify-content-center t-width-max">
                                            <div class="avatars avatars--rounded avatars--sm-plus t-mr-8">
                                                <img src="{{ asset('assets') }}/img/overlay-3.jpg" alt="max"
                                                    class="img-fulid w-100">
                                            </div>
                                            <div class="messages__content messages__content--unseen">
                                                <div class="messages__title">
